<div class="sb2-1">
                ...
                <div class="sb2-13">
                    <ul class="collapsible" data-collapsible="accordion">
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-list-ul" aria-hidden="true"></i> Pan card management</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    <li><a href="view-newapp.php?token=<?php echo $tokent; ?>">View New applications<span style="float: right; color:red;">2</span></a>
                                    </li>
                                    <li><a href="#">View Updated Application<span style="float: right; color:red;">2</span></a>
                                    </li>
                                    <li><a href="#">View Rejected Applictions<span style="float: right; color:red;">2</span></a>
                                    </li>
                                    <li><a href="#">Correction of application<span style="float: right; color:red;">2</span></a>
                                    </li>
                                </ul>
                            </div>
                        </li>
